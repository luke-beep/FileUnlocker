...
public class ActivationService : IActivationService
{
    ...
    public ActivationService(ActivationHandler<LaunchActivatedEventArgs> defaultHandler, IEnumerable<IActivationHandler> activationHandlers, IThemeSelectorService themeSelectorService, IBackdropSelectorService backdropSelectorService, IAlwaysOnTopService alwaysOnTopService, IUnlockerService unlockerService)
    {
    ...
    private async Task InitializeAsync()
    {
        ...
        await _unlockerService.InitializeAsync().ConfigureAwait(false);
